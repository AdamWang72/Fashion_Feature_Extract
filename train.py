...
def Load_Image_Information(path):
    # 图像存储路径
    image_Root_Dir = r'./data/Fashion144k_relabel/img2/'
    # 获取图像的路径
...
val_Data = my_Data_Set(r'./val.txt', transform=data_transforms['val'], loader=Load_Image_Information)
...
if __name__ ==  '__main__':
    ...
    model._fc = nn.Linear(in_features=feature,out_features=94,bias=True)
    # 获取最后一个全连接层的输入通道数
    ...
    # 添加上适用于自己数据集的全连接层
    # 260数据集的类别数
    #feature_model.append(nn.Linear(num_input, 94))
